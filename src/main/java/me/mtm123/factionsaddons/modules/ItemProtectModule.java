...
public class ItemProtectModule extends AbstractModule {
    ...
    private void makeInvulnerable(Item i){
        ...
        try {
            Class<?> cCraftEntity = ReflectionUtil.getClass(ReflectionUtil.Package.CRAFTBUKKIT, "entity.CraftEntity");
            Class<?> cNmsEntity = ReflectionUtil.getClass(ReflectionUtil.Package.MINECRAFT, "Entity");
